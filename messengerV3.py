...
def getCabeceras(cabecera):
	...
	actualizacion = "update app_notif_cuerpo set f_hs_ultimo_envio = now() where estado = 0 and fk_cabecera = "+str(cabecera[0])+" and (f_hs_ultimo_envio + INTERVAL 1 DAY <= now() or f_hs_ultimo_envio is null or c.f_hs_ultimo_envio = '0000-00-00 00:00:00')"
